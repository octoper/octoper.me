<template>
    <button title="Dark Mode" @click.prevent="toggle()" class="ml-6 dark:text-gray-100 dark-hover:text-white text-gray-700">
        <svg fill="none" stroke="currentColor" class="fill-current h-8 h-8"
