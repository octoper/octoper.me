<nav class="hidden lg:flex items-center justify-end text-lg">
    <button x-data="ToggleDark()" x-init="created()" title="Dark Mode" @click.prevent="toggle()" x-cloak
    ...
    <a title="{{ $page->siteName }} Projects" href="/work"
       class="ml-6 text-gray-700 under-1 {{ $page->isActive('/work') ? 'active text-black' : '' }}">
        Work
    </a>
    ...
    <a title="{{ $page->siteName }} Email" rel="noopener" target="_blank" href="mailto:{{ $page->social->email }}"
       class="ml-6 text-gray-500 hover:text-gray-900">
