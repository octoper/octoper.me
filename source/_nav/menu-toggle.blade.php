<button x-data="ToggleDark()" x-cloak x-init="created()" title="Dark Mode" @click.prevent="toggle()"
        class="lg:hidden ml-6 dark:text-gray-100 dark-hover:text-white text-gray-700">
...
<button class="flex justify-center items-center ml-8 lg:hidden focus:outline"
    ...
    <svg :class="{'hidden': openNav }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
         class="fill-current dark:text-white text-black h-10 w-10">
        <path d="M0 0h24v24H0V0z" fill="none"/>
        <path d="M4 18h16c.55 0 1-.45 1-1s-.45-1-1-1H4c-.55 0-1 .45-1 1s.45 1 1 1zm0-5h16c.55 0 1-.45 1-1s-.45-1-1-1H4c-.55 0-1 .45-1 1s.45 1 1 1zM3 7c0 .55.45 1 1 1h16c.55 0 1-.45 1-1s-.45-1-1-1H4c-.55 0-1 .45-1 1z"/>
    </svg>

    <svg :class="{'hidden': !openNav }" xmlns="http://www.w3.org/2000/svg"
         class="fill-current dark:text-white text-black h-10 w-10 hidden" viewBox="0 0 24 24">
